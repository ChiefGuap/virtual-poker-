...
public class PokerTester {
	...
	//Card card = new Card("", ""); This is how a card will be intialized 
	Card card;
	...
	/**
	 * Test's the different type of hands and prints out the value which is compared to the Expected value.
